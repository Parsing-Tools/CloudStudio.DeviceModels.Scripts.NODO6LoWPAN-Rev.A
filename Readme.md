...
# Configuration Script – NODO 6LoWPAN - Rev. A

This **Configuration** script is designed for the **NODO 6LoWPAN** model in **Gear Studio**, part of the [Cloud Studio](https://www.cloud.studio/) platform.
...
# Script de Configuration – NODO 6LoWPAN Rev. A

Este script de **Configuration** está diseñado para el modelo **NODO 6LoWPAN** en **Gear Studio**, parte de la plataforma [Cloud Studio](https://www.cloud.studio/).
